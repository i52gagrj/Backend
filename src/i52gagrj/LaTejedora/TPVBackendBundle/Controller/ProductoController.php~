...
use i52gagrj\LaTejedora\TPVFrontendBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
     ...
     {
         $params = array(
             'mensaje' => 'Gestion de Productos',
             'rutaCrear' => 'producto_new',  
             'rutaListado' => 'producto',  
         );
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('i52LTPVFrontendBundle:Producto')->findAll();

        return $this->render('i52LTPVBackendBundle:Producto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('i52LTPVBackendBundle:Producto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('i52LTPVFrontendBundle:Producto')->find($id);
        ...
        return $this->render('i52LTPVBackendBundle:Producto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('i52LTPVBackendBundle:Producto:edit.html.twig', array(
            'entity'      => $entity,
