...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.i52LTPV_publico' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/caja/(index|login$|datos|gestion)'), 'security.firewall.map.context.i52LTPV_protegido' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(caja|administracion)'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/caja/datos/login'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/caja/(datos|gestion)'))), $this->get('debug.event_dispatcher'));
    }
