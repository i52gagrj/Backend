...
use i52gagrj\LaTejedora\TPVFrontendBundle\Form\ProveedorType;
...
class ProveedorController extends Controller
{
   ...
   {
       $params = array(
           'mensaje' => 'Gestion de Proveedores',
           'rutaCrear' => 'proveedor_new',  
           'rutaListado' => 'proveedor',  
       );
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('i52LTPVFrontendBundle:Proveedor')->findAll();

        return $this->render('i52LTPVBackendBundle:Proveedor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('i52LTPVBackendBundle:Proveedor:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('i52LTPVFrontendBundle:Proveedor')->find($id);
        ...
        return $this->render('i52LTPVBackendBundle:Proveedor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('i52LTPVBackendBundle:Proveedor:edit.html.twig', array(
            'entity'      => $entity,
