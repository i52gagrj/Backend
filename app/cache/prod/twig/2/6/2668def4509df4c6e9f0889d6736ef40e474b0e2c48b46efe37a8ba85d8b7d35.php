...
class __TwigTemplate_2668def4509df4c6e9f0889d6736ef40e474b0e2c48b46efe37a8ba85d8b7d35 extends Twig_Template
{
    ...
    <div class=\"cierrecaja\" >
      ...
      ";
        // line 6
        if ((isset($context["anterior"]) ? $context["anterior"] : null)) {
            // line 7
            echo "        ";
            echo twig_escape_filter($this->env, twig_number_format_filter($this->env, ((isset($context["contado"]) ? $context["contado"] : null) + $this->getAttribute((isset($context["anterior"]) ? $context["anterior"] : null), "dejado", array())), 2, ".", ","), "html", null, true);
            echo "
      ";
        } else {
            // line 8
        ...
        ";
            // line 9
            echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (isset($context["contado"]) ? $context["contado"] : null), 2, ".", ","), "html", null, true);
            echo "
      ";
        }
        // line 11
      ...
      ";
        // line 14
        if ((isset($context["hoy"]) ? $context["hoy"] : null)) {
            // line 15
        ...
        ";
            // line 18
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["hoy"]) ? $context["hoy"] : null), "fecha", array()), "Y-m-d"), "html", null, true);
            echo "
        <br>
        <strong>Resto:</strong>
        ";
            // line 21
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["hoy"]) ? $context["hoy"] : null), "dejado", array()), "html", null, true);
            echo "      
      ";
        } else {
            // line 22
