...
class __TwigTemplate_e27dd98d3d8bb46565e04d29d4c7c7f10d6063083ead5bdc6d227f1504a0a536 extends Twig_Template
{
  ...
  ";
        // line 3
        if ((isset($context["venta"]) ? $context["venta"] : $this->getContext($context, "venta"))) {
            echo "   
    ";
            // line 4
            $context["base21"] = 0;
    ...
    <strong> Nombre: </strong> ";
            // line 12
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["venta"]) ? $context["venta"] : $this->getContext($context, "venta")), "socio", array()), "nombre", array()), "html", null, true);
            echo "
    <strong> DNI: </strong> ";
            // line 13
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["venta"]) ? $context["venta"] : $this->getContext($context, "venta")), "socio", array()), "dni", array()), "html", null, true);
            echo "<br>
    <strong> Vendedor: </strong> ";
            // line 14
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["venta"]) ? $context["venta"] : $this->getContext($context, "venta")), "usuario", array()), "nombre", array()), "html", null, true);
            echo "<br><br> 

    <strong>Venta original</strong><br>
    <strong> Fecha de venta: </strong> ";
            // line 17
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["venta"]) ? $context["venta"] : $this->getContext($context, "venta")), "fechaventa", array()), "Y-m-d"), "html", null, true);
            echo "
    <strong> Hora de venta: </strong> ";
            // line 18
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["venta"]) ? $context["venta"] : $this->getContext($context, "venta")), "horaventa", array()), "H:i:s"), "html", null, true);
            echo "
    <table>
      <tr>
      ...
      ";
          ...
          ";
            ...
            ";
                    // line 34
                    $context["base21"] = ((isset($context["base21"]) ? $context["base21"] : $this->getContext($context, "base21")) + ($this->getAttribute($context["linea"], "precio", array()) * $this->getAttribute($context["linea"], "cantidad", array())));
                    echo "  
          ";
                }
                // line 36
            ...
            ";
                    // line 37
                    $context["base10"] = ((isset($context["base10"]) ? $context["base10"] : $this->getContext($context, "base10")) + ($this->getAttribute($context["linea"], "precio", array()) * $this->getAttribute($context["linea"], "cantidad", array())));
                    echo "  
          ";
                }
                // line 38
          ...
          ";
            ...
            ";
                    // line 40
                    $context["base4"] = ((isset($context["base4"]) ? $context["base4"] : $this->getContext($context, "base4")) + ($this->getAttribute($context["linea"], "precio", array()) * $this->getAttribute($context["linea"], "cantidad", array())));
                    echo "  
          ";
                }
                // line 41
    ...
    ";
            // line 70
            echo twig_escape_filter($this->env, (isset($context["totaloriginal"]) ? $context["totaloriginal"] : $this->getContext($context, "totaloriginal")), "html", null, true);
            echo "  
