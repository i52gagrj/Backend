 ...
 */
class Producto extends \i52gagrj\LaTejedora\TPVFrontendBundle\Entity\Producto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setProveedor(\i52gagrj\LaTejedora\TPVFrontendBundle\Entity\Proveedor $proveedor = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProveedor', array($proveedor));
